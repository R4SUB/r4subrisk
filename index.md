...
It uses an **FMEA-inspired framework** (Probability × Impact ×
...
- **Detectability**: difficulty of catching the issue (1 = easy, 5 =
  hard)

**RPN** (Risk Priority Number) = Probability × Impact × Detectability
(range 1–125)
